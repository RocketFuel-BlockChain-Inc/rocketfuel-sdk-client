                ...
                switch (btnType.feature) {
                    case FEATURE_PAYIN.feature: {
                        ...
                        button.onclick = () => __awaiter(this, void 0, void 0, function* () {
                            ...
                            try {
                                const { placeOrder } = yield Promise.resolve().then(function () { return require('./index-1d6ee147.cjs.js'); });
                    ...
                    case FEATURE_AGE_VERIFICATION.feature: {
                        ...
                        button.onclick = () => __awaiter(this, void 0, void 0, function* () {
                            const { initializeWidget, launchAgeVerificationWidget } = yield Promise.resolve().then(function () { return require('./index-3bfdb198.cjs.js'); });
