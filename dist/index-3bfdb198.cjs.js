...
var index = require('./index-048ade24.cjs.js');
require('crypto-js');

class ZKP {
    constructor(clientId, env, redirect) {
        this.appUrl = index.appDomains[env];
    ...
    initialize(userInfo) {
        if (this.redirect) {
            ...
            index.IframeUtiltites.showOverlay(`${this.appUrl}`, index.FEATURE_AGE_VERIFICATION.feature);
        ...
        return index.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (eventType === 'accountDisconnected') {
                    (_b = (_a = index.IframeUtiltites.iframe) === null || _a === void 0 ? void 0 : _a.contentWindow) === null || _b === void 0 ? void 0 : _b.postMessage('concordium_disconnected', index.IframeUtiltites.iframe.src);
                    return;
                }
                if (!type)
...
exports.initializeWidget = initializeWidget;
